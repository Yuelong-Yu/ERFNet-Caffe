...
# -*- coding: utf-8 -*-
"""
This script merge BatchNorm & Scale layers into Convolution layers; and remove dropout layer in test phase to accelerate prediction
"""
...
# The bias of convolution layer was set to false becasue the batchnorm layer remove the mean; To remove batchnorm layer in test phase, change bias to true    
...
# Merge the weights of batchnorm and scale layer into convolution layer     
...
# Remove BatchNorm , Scale and Dropout layer in net prototxt
to_delete_empty = []
...
#---------------Change dir to your model and weights; the model and weights with merged BatchNorm, Scale and Dropout layer will be generated---------------    
if __name__ == '__main__':
    parser = ArgumentParser()
    parser.add_argument('--model', type=str, default='/home/yly/ERFNet/prototxts/erfnet_deploy.prototxt')
    parser.add_argument('--weights', type=str, default='/home/yly/ERFNet/weights/erfnet_cityscapes.caffemodel')
    parser.add_argument('--output_model',default="/home/yly/ERFNet/prototxts/erfnet_deploy_mergebn_dele.prototxt")
    parser.add_argument('--output_weights',default="/home/yly/ERFNet/weights/erfnet_cityscapes_mergebn_dele.caffemodel")
