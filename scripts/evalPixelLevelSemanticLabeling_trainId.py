...
'''
This is a modified version of evalPixelLevelSemanticLabeling.py which use the images of trainID to eval IoU;
1. Change the dir of groundTruth file and predition file according to you dir
2. GroudTruthImg can be resized to match your prediction images if the resolution of your prediction images are not 2048x1024, change the resize parameters in the following script
'''
...
# The original version of the script is by Marius Cordts, https://github.com/mcordts/cityscapesScripts/tree/master/cityscapesscripts/evaluation 
...
#----------------------------groundTruth file---------------------------------
args.groundTruthSearch  = os.path.join( "/media/yly/AIvehicle/CITYSCAPES_DATASET/" , "gtFine" , "val" , "*", "*_gtFine_labelTrainIds.png" )
...
def evaluatePair(predictionImgFileName, groundTruthImgFileName, confMatrix, instanceStats, perImageStats, args):
    ...
    try:
        ...
        #--------------The 3-channel image of the prediction results is converted single channel--------------------------    
